package com.rsa.releng.simple_war;
...
public class MyApplicationModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        Configuration conf = Configuration.getDefaults()
          .add(RESOURCE_PATH, "com.rsa.releng.simple_war")
          .add(VIEW_COMPONENT_ROOT_PACKAGE, "com.rsa.releng.simple_war.web.views")
          .add(RELOADABLE_CLASSES.includedPackage("com.rsa.releng.simple_war.web.components"))
